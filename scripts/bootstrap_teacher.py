...
def main() -> None:
    parser = argparse.ArgumentParser(description="Create or update a local teacher account.")
    parser.add_argument("--username", default="teacher")
    parser.add_argument("--display-name", default="教师管理员")
    ...
    if not args.skip_migrations:
        apply_migrations()
    bootstrap_user(args.username, password, args.display_name, "teacher")
    print(f"teacher account is ready: {args.username}")
