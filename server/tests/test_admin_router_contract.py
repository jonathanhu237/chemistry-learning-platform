...
ADMIN_ROUTE_CONTRACTS = [
    ...
    ("POST", "/api/admin/teacher-accounts/{account_id}/reset-password"),
    ("POST", "/api/admin/teacher-accounts/{account_id}/disable"),
    ("POST", "/api/admin/teacher-accounts/{account_id}/enable"),
