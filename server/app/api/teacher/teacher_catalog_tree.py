...
router = APIRouter(prefix="/api/teacher/catalog", tags=["teacher-catalog-tree"])


@router.get("/chapters/{chapter_id}/roots")
async def teacher_catalog_chapter_roots(
...
async def teacher_catalog_chapter_summary(
    chapter_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_catalog_node_children(
...
async def teacher_catalog_node_detail(
    node_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
@router.post("/nodes")
async def teacher_catalog_create_node(
...
async def teacher_catalog_update_node(
...
async def teacher_catalog_move_node(
...
async def teacher_catalog_copy_node(
...
async def teacher_catalog_reorder_nodes(
...
async def teacher_catalog_node_status(
...
async def teacher_catalog_node_preview_token(
    node_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> CatalogPreviewTokenResponse:
...
async def teacher_catalog_save_point_content(
...
async def teacher_catalog_preview_equations(
...
async def teacher_catalog_assist_equations(
...
async def teacher_catalog_point_content_publication(
...
async def teacher_catalog_bind_media(
...
async def teacher_catalog_media_binding_status(
...
async def teacher_catalog_replace_related_links(
...
async def teacher_catalog_validate_node(
    node_id: str = Path(min_length=1),
...
async def teacher_catalog_point_job_state(
    node_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_catalog_point_ai_context(
    node_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_catalog_point_rag_probe(
    node_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_catalog_trigger_point_job(
    node_id: str = Path(min_length=1),
...
@router.get("/search")
async def teacher_catalog_search(
