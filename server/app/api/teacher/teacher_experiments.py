...
async def teacher_list_experiments(
...
async def teacher_get_experiment(
...
async def teacher_list_experiment_videos(
...
async def teacher_video_library_index_diagnostics(
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_video_library_search_diagnostics(
    q: str = "",
    limit: int = 10,
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
