...
async def teacher_list_question_bank_chapters(
...
async def teacher_list_chapter_questions(
...
async def teacher_question_bank_assistant_preview(
...
async def teacher_list_question_banks(
    experiment_id: str | None = None,
    chapter_id: str | None = None,
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_list_catalog_question_bank(
    chapter_id: str | None = None,
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_refresh_catalog_question_bank_evidence(
...
async def teacher_publish_question(
    question_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_disable_question(
    question_id: str = Path(min_length=1),
    user: AuthUser = Depends(require_teacher_user),
) -> dict[str, Any]:
...
async def teacher_import_question_bank(
...
async def teacher_export_question_bank(
    experiment_id: str | None = None,
