...
def build_teacher_debug_agent_request(
    payload: Any,
    user: Any,
    *,
...
async def run_teacher_debug_agent(
    payload: Any,
    user: Any,
    *,
    settings: Settings,
    ...
    return await run_agent(
        build_teacher_debug_agent_request(payload, user, rag_access_enabled=rag_access_enabled),
        settings=settings,
    )


async def stream_teacher_debug_agent(
    payload: Any,
    user: Any,
    *,
    settings: Settings,
    ...
    request = build_teacher_debug_agent_request(payload, user, rag_access_enabled=rag_access_enabled)
