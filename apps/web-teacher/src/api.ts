...
export function getTeacherClassSmartAssessmentStrategy(classId: string): Promise<SmartAssessmentStrategyResponse> {
  return api<SmartAssessmentStrategyResponse>(`/api/teacher/classes/${encodeURIComponent(classId)}/smart-assessment-strategy`);
}

export function updateTeacherClassSmartAssessmentStrategy(
  classId: string,
  payload: SmartAssessmentSettings,
): Promise<SmartAssessmentStrategyResponse> {
  return putJson<SmartAssessmentStrategyResponse>(`/api/teacher/classes/${encodeURIComponent(classId)}/smart-assessment-strategy`, payload);
}

export function clearTeacherClassSmartAssessmentStrategy(classId: string): Promise<SmartAssessmentStrategyResponse> {
  return api<SmartAssessmentStrategyResponse>(`/api/teacher/classes/${encodeURIComponent(classId)}/smart-assessment-strategy`, {
    method: "DELETE",
  });
}
